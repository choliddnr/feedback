export default defineEventHandler(async (e) => {
  ...
  // try {
  // const _merchant = await db.insert(merchants).values(merchant).returning();
  // const _product = await db.insert(products).values(product).returning();
  // const _question = await db.insert(questions).values(question).returning();
  // const _respondent = await db
  //   .insert(respondents)
  //   .values(respondent)
  //   .returning();
  // const _response = await db.insert(responses).values(response).returning();
