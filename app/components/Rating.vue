  ...
  <div class="flex justify-center w-full mx-auto">
    <div class="text-warning" role="button" @click="model = 1">
      ...
      >
        ...
        <path
          :fill="model >= 1 ? 'currentColor' : 'none'"
          stroke="currentColor"
    ...
    <div class="text-warning" role="button" @click="model = 2">
      ...
      >
        <!-- Icon from HeroIcons by Refactoring UI Inc - https://github.com/tailwindlabs/heroicons/blob/master/LICENSE -->
        <path
          :fill="model >= 2 ? 'currentColor' : 'none'"
          stroke="currentColor"
          stroke-linecap="round"
          stroke-linejoin="round"
          stroke-width="1.5"
    ...
    <div class="text-warning" role="button" @click="model = 3">
      ...
      >
        <!-- Icon from HeroIcons by Refactoring UI Inc - https://github.com/tailwindlabs/heroicons/blob/master/LICENSE -->
        <path
          :fill="model >= 3 ? 'currentColor' : 'none'"
          stroke="currentColor"
          stroke-linecap="round"
          stroke-linejoin="round"
          stroke-width="1.5"
    ...
    <div class="text-warning" role="button" @click="model = 4">
      ...
      >
        <!-- Icon from HeroIcons by Refactoring UI Inc - https://github.com/tailwindlabs/heroicons/blob/master/LICENSE -->
        <path
          :fill="model >= 4 ? 'currentColor' : 'none'"
          stroke="currentColor"
          stroke-linecap="round"
          stroke-linejoin="round"
          stroke-width="1.5"
    ...
    <div class="text-warning" role="button" @click="model = 5">
      ...
      >
        <!-- Icon from HeroIcons by Refactoring UI Inc - https://github.com/tailwindlabs/heroicons/blob/master/LICENSE -->
        <path
          :fill="model >= 5 ? 'currentColor' : 'none'"
          stroke="currentColor"
          stroke-linecap="round"
          stroke-linejoin="round"
          stroke-width="1.5"
